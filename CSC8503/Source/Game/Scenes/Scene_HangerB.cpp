 ...
 * @brief HangerB level scene lifecycle (resource loading, entity creation, system registration).
 */
                            ...
                            const Res_NCL_Pointers& /*nclPtrs*/)
{
    ...
    strncpy_s(mapConfig.itemSpawns,    sizeof(mapConfig.itemSpawns),    "HangerB.itemspawns", _TRUNCATE);
