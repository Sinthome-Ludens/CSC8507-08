/**
 * @file Scene_Lab.cpp
 * @brief Lab level scene lifecycle.
 */
#include "Scene_Lab.h"
                        ...
                        const Res_NCL_Pointers& /*nclPtrs*/)
{
    ...
    config.sceneName     = "Scene_Lab";
    config.mapConfigJson = "Prefab_Map_Lab.json";
    ...
    LOG_INFO("[Scene_Lab] OnEnter complete. " << systems.Count() << " systems awake.");
}
