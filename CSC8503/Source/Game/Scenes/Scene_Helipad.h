...
/**
 * @brief Helipad 关卡（对应 Helipad.obj + Helipad.navmesh）
 *
 * 注册并启动以下系统：
 ...
 */
class Scene_Helipad : public IScene {
public:
    Scene_Helipad()  = default;
    ~Scene_Helipad() = default;
    ...
    IScene* CreateRestartScene() override { return new Scene_Helipad(); }
