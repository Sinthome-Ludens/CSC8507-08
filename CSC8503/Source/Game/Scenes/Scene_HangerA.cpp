 ...
 * @brief HangerA level scene lifecycle.
 */
                            ...
                            const Res_NCL_Pointers& /*nclPtrs*/)
{
    ...
    config.sceneName     = "Scene_HangerA";
    config.mapConfigJson = "Prefab_Map_HangerA.json";
    ...
    LOG_INFO("[Scene_HangerA] OnEnter complete. " << systems.Count() << " systems awake.");
}
